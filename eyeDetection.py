...
faceCascade = cv2.CascadeClassifier(r"classifier2/haarcascade_eye.xml")  # xml uzantılı hazır veri setini projeye classifier klasörü oluşturup o klasörün içine aktardım
